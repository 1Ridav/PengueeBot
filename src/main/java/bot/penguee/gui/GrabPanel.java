...
public class GrabPanel extends JPanel {
	...
	private void init() {
		...
		JLabel lblNewLabel = new ActiveJLabel("GRAB");
		...
		ActiveJLabel btnNewButton = new ActiveJLabel("Delay 3 sec");
		...
		ActiveJLabel btnNewButton_1 = new ActiveJLabel("Delay 5 sec");
		...
		ActiveJLabel btnNewButton_2 = new ActiveJLabel("Delay 8 sec");
		...
		JLabel lblTest = new ActiveJLabel("TEST");
		...
		ActiveJLabel labelCountAllMatches = new ActiveJLabel("Count all matches");
		...
		ActiveJLabel labelTestMono = new ActiveJLabel("Test MONO");
		...
		ActiveJLabel labelTestAllMono = new ActiveJLabel("Count all MONO");
