...
public class SettingsPanel extends JPanel {
	...
	private void init() {
		...
		ramSlider.setValue(Integer.parseInt(Data.getXmxValue()));

		final ToggleJLabel useCacheToggle = new ToggleJLabel();
		...
		useCacheToggle.setSelected(Data.getUseInternalCache());
		...
		final ToggleJLabel forceGPUToggle = new ToggleJLabel();
		...
		forceGPUToggle.setSelected(Data.getForceUseGPU());
		forceGPUToggle.setBounds(456, 137, 64, 50);
		menuCentral.add(forceGPUToggle);

		JLabel lblNewLabel_3 = new ActiveJLabel("Save");
